    ...
    >
      ...
      <div className="space-y-1.5">
        <label
          ...
          className="block text-base font-semibold text-stone-700"
        >
          Learning objective{" "}
        ...
        <textarea
          ...
          className="w-full resize-none rounded-xl border border-stone-300 bg-stone-50 px-4 py-3.5 text-base text-stone-800 transition placeholder:text-stone-400 focus:border-transparent focus:ring-2 focus:ring-indigo-400 focus:outline-none"
          disabled={isLoading}
        />
      ...
      {/* Subject + Grade — labels on row 1, inputs on row 2 */}
      <div className="grid grid-cols-2 gap-x-4 gap-y-1.5">
        ...
        <input
          ...
          className="w-full rounded-xl border border-stone-300 bg-stone-50 px-4 py-3 text-base text-stone-800 transition placeholder:text-stone-400 focus:border-transparent focus:ring-2 focus:ring-indigo-400 focus:outline-none"
          disabled={isLoading}
        />
        <input
          id="gradeLevel"
      ...
      <button
        type="submit"
        disabled={isLoading}
        className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 px-8 py-3.5 text-base font-semibold text-white transition-colors hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-400 focus:ring-offset-2 focus:outline-none disabled:bg-indigo-300 sm:w-auto"
      >
        {isLoading ? (
          <>
